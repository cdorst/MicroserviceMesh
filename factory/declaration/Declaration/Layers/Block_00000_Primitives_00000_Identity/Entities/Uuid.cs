...
{
    /// <summary>Contains declaration describing Uuid entity types</summary>
    public static class Uuid
    {
        /// <summary>Contains declaration representing this entity type</summary>
        public static readonly Entity Declaration = Entity("00000_Primitives", "00000_Identity", "Uuid", default);
    }
}
