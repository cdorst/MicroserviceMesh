...
{
    public interface IPermissionRead<TElement, TKey, TDatum, TDatumKey, TDatumValue>
        : IPermission<TElement, TKey, TDatum, TDatumKey, TDatumValue>
        where TElement : IPermissionRead<TElement, TKey, TDatum, TDatumKey, TDatumValue>
    ...
    public interface IPermissionRead<TElement, TKey, TDatumLabel, TDatumLabelKey, TDatum, TDatumKey, TDatumValue>
        : IPermission<TElement, TKey, TDatumLabel, TDatumLabelKey, TDatum, TDatumKey, TDatumValue>
        where TElement : IPermissionRead<TElement, TKey, TDatumLabel, TDatumLabelKey, TDatum, TDatumKey, TDatumValue>
        where TKey : unmanaged, IEquatable<TKey>
        where TDatumKey : unmanaged, IEquatable<TDatumKey>
    ...
    public interface IPermissionRead<TElement, TKey, THierarchy, THierarchyKey>
        : IPermission<TElement, TKey, THierarchy, THierarchyKey>
        where TElement : IPermissionRead<TElement, TKey, THierarchy, THierarchyKey>
        where TKey : unmanaged, IEquatable<TKey>
