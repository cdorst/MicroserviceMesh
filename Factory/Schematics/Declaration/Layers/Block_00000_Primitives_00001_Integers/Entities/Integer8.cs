...
{
    /// <summary>Contains declaration describing Integer8 entity types</summary>
    public static class Integer8
    {
        /// <summary>Contains declaration representing this entity type</summary>
        public static readonly Entity Declaration = Entity(BlockName, LayerName, nameof(Integer8), valueType: "Byte", valueNamespace: "System", keySize: 32);
    }
}
