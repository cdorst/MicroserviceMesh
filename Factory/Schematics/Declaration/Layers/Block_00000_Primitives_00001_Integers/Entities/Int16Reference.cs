...
{
    /// <summary>Contains declaration describing Int16Reference entity types</summary>
    public static class Int16Reference
    {
        /// <summary>Contains declaration representing this entity type</summary>
        public static readonly Entity Declaration = Entity(BlockName, LayerName, nameof(Int16Reference), valueType: "Integer16", keySize: 32);
    }
}
