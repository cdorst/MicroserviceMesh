...
{
    /// <summary>Contains declaration describing Agent entity types</summary>
    public static class Agent
    {
        /// <summary>Contains declaration representing this entity type</summary>
        public static readonly Entity Declaration = Entity(BlockName, LayerName, nameof(Agent), default, default);
    }
}
