...
namespace Declaration.Layers.Block_00000_Primitives_00002_Strings
{
    ...
    public static class StringAscii900
    {
        ...
        public static readonly Entity Declaration = Entity(BlockName, LayerName, nameof(StringAscii900), valueType: "String", valueNamespace: "System", attributes: Attributes(columnType: "varchar(900)"), keySize: 32);
    }
}
